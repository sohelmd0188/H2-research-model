# ------------------------------------------------------------
# Research Hydrogen Model (Ready-to-Run)
# Streamlit App
# Run with:
#   cd "C:\Users\Sohel pc\Downloads\research_model (1)\h2model"
...
def demo_df():
    months = ["Jan 25","Feb 25","Mar 25", "Apr 24","May 24","Jun 24","Jul 24","Aug 24","Sep 24","Oct 24","Nov 24","Dec 24",]
